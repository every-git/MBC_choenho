...
<div class="row justify-content-center">
  <div class="col-lg-12">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <form id="actionForm" action="${pageContext.request.contextPath}/board/modify" method="post">
          ...
          <input type="hidden" name="delFlag" value="<c:out value='${board.delFlag}'/>">
...
<script type="text/javascript">
  ...
  document.querySelector(".btnList").addEventListener("click", ()=>{
    formObj.action = "${pageContext.request.contextPath}/board/list";
    formObj.method = "get";
    formObj.submit();
  })
